...
pub fn fir_filter(samples: &FirSampleDeque) -> i32 {
    FILTER
        .iter()
        .copied()
...
pub struct ReverbUnit {
    ...
    pub cd_enabled: bool,
    voices_enabled: [bool; NUM_VOICES],
...
impl ReverbUnit {
    pub fn clock(
        ...
        let input_sample = match self.clock {
            ReverbClock::Left => fir_filter(&self.input_buffer_l),
            ReverbClock::Right => fir_filter(&self.input_buffer_r),
        };
        ...
        let filtered_l = (fir_filter(&self.output_buffer_l) << 1).clamp_to_i16();
        let filtered_r = (fir_filter(&self.output_buffer_r) << 1).clamp_to_i16();
        ...
        if self.clock == ReverbClock::Right {
            self.buffer_current_addr = cmp::max(
                ...
                self.buffer_current_addr.wrapping_add(2) & SOUND_RAM_MASK,
            );
        }
    ...
    fn reverb_buffer_len(&self) -> u32 {
        SOUND_RAM_LEN as u32 - self.buffer_start_addr
    }
    ...
    pub fn write_output_volume_l(&mut self, value: u32) {
        ...
        debug!("Reverb output volume L: {}", self.output_volume.l);
    }
    ...
    pub fn write_output_volume_r(&mut self, value: u32) {
        ...
        debug!("Reverb output volume R: {}", self.output_volume.r);
    }
    ...
    pub fn write_reverb_on_low(&mut self, value: u32) {
        ...
        debug!("Reverb enabled (voices 0-15): {value:04X}");
    }
    ...
    pub fn write_reverb_on_high(&mut self, value: u32) {
        ...
        debug!("Reverb enabled (voices 16-23): {value:04X}");
    }
    ...
    pub fn write_buffer_start_address(&mut self, value: u32) {
        ...
        debug!("Reverb buffer start address: {:05X}", self.buffer_start_addr);
    }
    ...
    fn write_mlsame(&mut self, value: u32) {
        ...
        debug!("mLSAME: {:05X}", self.same_reflect_addr_1.l);
    }
    ...
    fn write_dlsame(&mut self, value: u32) {
        ...
        debug!("dLSAME: {:05X}", self.same_reflect_addr_2.l);
    }
    ...
    fn write_drsame(&mut self, value: u32) {
        ...
        debug!("dRSAME: {:05X}", self.same_reflect_addr_2.r);
    }
    ...
    fn write_mldiff(&mut self, value: u32) {
        ...
        debug!("mLDIFF: {:05X}", self.diff_reflect_addr_1.l);
    }
    ...
    fn write_dldiff(&mut self, value: u32) {
        ...
        debug!("dLDIFF: {:05X}", self.diff_reflect_addr_2.l);
    }
